    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        */
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            String queryPassword = "SELECT DISTINCT employees.password FROM employees WHERE employees.email = ?;";
            PreparedStatement statement = conn.prepareStatement(queryPassword);
