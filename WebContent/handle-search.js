var suggestionsCache = JSON.parse(localStorage.getItem('suggestionsCache')) || {};
...
function handleLookup(query, doneCallback) {
    ...
    if (suggestionsCache.hasOwnProperty(query)) {
        ...
        jQuery.ajax({
            ...
            "url": "api/searchSuggestion?query=" + query,
...
function handleLookupAjaxSuccess(data, query, doneCallback) {
    ...
    localStorage.setItem('suggestionsCache', JSON.stringify(suggestionsCache));
